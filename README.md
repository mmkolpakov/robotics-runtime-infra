...
Cross-repo integration workflow `cross-repo-integration` поднимает infra image, ставит pinned contracts/harness, выполняет реальный `robotics-harness run` против Compose и подписывает evidence Cosign keyless.

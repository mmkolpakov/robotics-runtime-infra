...
ci_yq -o=json test/transport/scenario.yaml \
  > tmp/transport-scenario.json
test "$(ci_policy_deny_count policy/scenario.rego scenario tmp/transport-scenario.json)" -eq 0
